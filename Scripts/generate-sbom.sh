...
cat > "$OUTPUT" <<JSON
{
  ...
  "components": [
    ...
    {"type": "application", "name": "wallpaperengine-mac-renderer", "version": "7acc6c9-be1", "properties": [{"name": "background-engine:upstream-ref", "value": "7acc6c92e0175d53e1cb6b2b2dff52f79faf83e0"}], "licenses": [{"license": {"id": "GPL-3.0-only"}}]},
