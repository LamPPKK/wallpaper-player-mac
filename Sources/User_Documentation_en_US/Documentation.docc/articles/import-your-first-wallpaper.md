...
for that wallpaper. WebAudio receives neutral audio data. A package that relies
on controls attached to native Video/Image playback, Lively buttons, or adding
new files through a folder dropdown remains playable with a **Limited**
explanation.
