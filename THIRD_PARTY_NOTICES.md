...
- **Simple System v2.0** — source/notice commit `1a75e7100a5b3baf1e1741c8c5733c1c56610320`; archive size `1,200,818` bytes; SHA-256 `edd75a3d7da63061b28b6776029fabf454f765a393adfba2c0c917c943c46ad7`; MIT project notice with retained Chart.js, Moment.js and artwork credits. Charts animate with neutral values because Windows Lively hardware telemetry and chart pointer input are unavailable, so the missing live capabilities are reported **Limited**.
- **Simple System 3D v2.0** — source/notice commit `1a75e7100a5b3baf1e1741c8c5733c1c56610320`; archive size `13,460,519` bytes; SHA-256 `f5b890ed53c927de6c76b2a9a81898d96f668a4978c71f6d94e865ad7c9321b6`; MIT code with retained CC0, CC BY 4.0, CC BY-NC 4.0 and other asset credits. The 3D scene remains visible, while unavailable hardware, Windows media, system-audio and pointer inputs are reported **Limited**; dynamically constructed requests stay governed by the per-wallpaper network permission.
- **Weather Demo v1** — source/notice commit `4fbd75b14d8105e4c5f246e1ce4fd27e2ab01172`; archive size `77,763` bytes; SHA-256 `08f6f27a30f444c20ddbea74d0e7da980e5582cf021c6821dd8401967fb2d1a0`; MIT project code with retained weather-icon and SIL Open Font License 1.1 notices. It needs a user-supplied OpenWeatherMap key and explicit per-wallpaper network permission; the key is stored only in private local library metadata.
...
- **AudiOrbits v1.0.0.0** — source/notice commit `cf1986f052446af0ac6c076a8258b376591a2278`; archive size `1,706,251` bytes; SHA-256 `d832ed8955c47ebea3190794f96697c4527c5ce84ce63b03b9cb9bd23f305ae4`; GPL-3.0 with its full license retained in the downloaded package. Automatic orbit motion and native property controls remain available; unavailable system-audio reactivity and cursor parallax are reported **Limited**, while dynamically constructed requests stay governed by the per-wallpaper network permission.
...
Other reviewed upstream samples remain manual imports rather than one-click downloads. Fluids and depth-map projects would duplicate safer curated derivatives already included here; other music/media samples either duplicate the included Music TV wallpaper, lack a stable release archive, or have additional asset/provenance constraints. Windows executable wallpapers remain unsupported and are never launched.
